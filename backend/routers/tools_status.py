...
router = APIRouter(prefix="/api/v1/tools", tags=["tools-status"])

_TOOL_ENDPOINTS: dict[str, str] = {
    "game-dev": "/api/v1/build/app/scaffold",
    "app-builder": "/api/v1/build/app/scaffold",
    "architectural-designer": "/api/v1/spatial/blueprint",
    "business-site-maker": "/business_builder/plan",
    "interior-landscape": "/api/v1/spatial/blueprint",
